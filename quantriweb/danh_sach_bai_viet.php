...
<head>
    ...
    <style>
        ...
        .post img {
            max-width: 150px; /* Giảm kích thước hình ảnh */
            height: auto;
            border-radius: 8px;
            margin-right: 20px; /* Khoảng cách giữa hình ảnh và phần văn bản */
        }

        .post-details {
            flex-grow: 1; /* Để chiếm phần còn lại của không gian */
        }
        ...
        /* Các nút sửa và xóa nằm ngang */
        .post .action-btns {
            display: flex; /* Các nút nằm trên cùng một dòng */
            margin-top: 10px;
        }

        .post .btn-edit, .post .btn-delete {
            font-size: 0.9rem;
            padding: 5px 10px;
            margin-right: 10px;
            border-radius: 5px;
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            <div class="post">
                ...
                <div class="post-details">
                    ...
                    <!-- Tác giả -->
                    <p class="author">Tác giả: <?php echo $row['author']; ?></p>

                    <!-- Nội dung bài viết -->
                    <p class="content"><?php echo substr($row['content'], 0, 150); ?>...</p>

                    <!-- Nút đọc thêm -->
                    <a href="post.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Đọc thêm</a>
                </div>

                <!-- Các nút sửa và xóa nằm cùng hàng -->
                <div class="action-btns">
                    <a href="edit-post.php?id=<?php echo $row['id']; ?>" class="btn btn-edit">Sửa</a>
                    <a href="delete-post.php?id=<?php echo $row['id']; ?>" class="btn btn-delete" onclick="return confirm('Bạn có chắc chắn muốn xóa bài viết này?');">Xóa</a>
                </div>
            </div>
        <?php endwhile; ?>
    <?php else: ?>
